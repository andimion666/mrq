...
// Copyright (c) 2015-2017 The PIVX Developers, The SHADOW Developers
...
static Checkpoints::MapCheckpoints mapCheckpoints =
    ...
    (0, uint256("0x15c1bc13be0948085fb0093da11f11a2fea90b1fb30ab3db32ba7ae059d02997"));
static const Checkpoints::CCheckpointData data = {
    &mapCheckpoints,
    1530646086, // * UNIX timestamp of last checkpoint block
...
public:
    CMainParams()
    {
        ...
        genesis.nVersion = 1;
        genesis.nTime = 1530646086;
        genesis.nBits = 0x1e0ffff0;
        genesis.nNonce = 20552486;

        hashGenesisBlock = genesis.GetHash();

        assert(hashGenesisBlock == uint256("0x15c1bc13be0948085fb0093da11f11a2fea90b1fb30ab3db32ba7ae059d02997"));
        assert(genesis.hashMerkleRoot == uint256("0x6b578a5a983afad6a6ac8036acbc9c3a4416932e4d0aebed3ec0cb3d0d745a69"));

        vSeeds.push_back(CDNSSeedData("45.63.104.116","45.63.104.116"));
        vSeeds.push_back(CDNSSeedData("90.168.243.42","90.168.243.42"));
        ...
        //  BIP44 coin type is from https://github.com/satoshilabs/slshadow/blob/master/slip-0044.md
